...
import dxc from './Thumbs/dxc.jpg';
...
const data = [
  {
    ...
    intro: (
      <>
        <p>
          DXC is a global IT company which specialize in both next-gen and
          cutting-edge solutions in areas such as Mobility, Insurance,
          Healthcare and Life Sciences, etc.
        </p>
        <p>
          I joined DXC as Senior Frontend developer to remote maintenance and
          feature implementation for their clients.
        </p>
      </>
    ),
  },
  {
    ...
    intro: (
      <>
        <p>
          The company with traditional business of printing. Sezax Corporation
          in Japan was founded in 1948
        </p>
        <p>
          I joined Sezax as frontend leader, implement Sezax their own projects.
        </p>
      </>
    ),
  },
  {
    ...
    intro: (
      <>
        <p>
          Hyakusenrenma is japanese company with stayjapan.com is main business
          that's provide home-sharing services.
        </p>
  ...
  },
  {
    ...
    intro: (
      <>
        <p>
          Sutrix Group offers on-site digital consultancy and digital production
          services globally.
        </p>
        <p>
          I was joined sutrix as a frontender to remote support a team in
          singapore.
        </p>
      </>
    ),
  },
  {
    ...
    intro: (
      <>
        <p>
          redWEB.vn is product company of denmark, provide ecommercer
          products/solutions base on joomla-cms.
        </p>
        <p>
          I was joined redweb as a frontender and support joomla template team.
        </p>
      </>
    ),
  },
...
class Careers extends React.Component {
  ...
  render() {
    const items = data.map((currentValue, idx) => {
      if (idx % 2 == 0) {
        return (
          <dl key={idx} className="row time-line-row align-items-stretch">
        ...
        <div className="row justify-content-center">
          <div className="col-lx-6 col-lg-9 time-line">
            ...
            <div className="row time-line-row d-none d-lg-flex">
              <div className="col-sm-3  offset-lg-5 col-lg-2 time-line-title" />
